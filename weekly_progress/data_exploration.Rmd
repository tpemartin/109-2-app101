...
taskdata$before %>%
  align_date(
    date_colname = "date",
    freq = "yearly" # monthly daily quarterly
  )
```
...
https://www.twse.com.tw/exchangeReport/STOCK_DAY?response=csv&date=20210501&stockNo=2330&dl=1
...
```{r}
link <- "https://raw.githubusercontent.com/jilufu/109-2-app101/5335adad8e220f85c26c37b4d367babcb7e7c4c0/weekly_progress/jilu/cpi.Rmd"
filename <- basename(link)
  xfun::download_file(link, output=filename , mode="wb")
file.edit(filename)
```

```{r}
download_open("https://raw.githubusercontent.com/chao87119/109-2-app101/main/weekly_progress/frank/cpi.R")
```
